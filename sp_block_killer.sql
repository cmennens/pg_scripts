/*
===============================================================================
Stored Procedure: manage_long_running_queries
-------------------------------------------------------------------------------
Purpose:
...
1. List all queries running longer than 10 minutes (DO NOT terminate):
    CALL manage_long_running_queries('10 minutes', FALSE);

2. Terminate all queries running longer than 15 minutes:
    CALL manage_long_running_queries('15 minutes', TRUE);

3. Use default settings (list queries > 5 minutes, no termination):
    CALL manage_long_running_queries();
...
CREATE OR REPLACE PROCEDURE manage_long_running_queries(
